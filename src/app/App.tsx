    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-3xl border border-border p-8">
          ...
          <button onClick={onSuccess} className="w-full mt-6 bg-primary text-primary-foreground font-semibold py-3.5 rounded-2xl hover:opacity-90 transition-opacity text-sm">
          ...
          <div className="mt-6 text-center">
            ...
            <button onClick={() => setMode(mode === "register" ? "login" : "register")} className="text-primary text-sm font-medium hover:underline">
...
export default function App() {
  ...
  const handleAuthSuccess = () => setView("onboarding");
  const handleOnboardFinish = () => { setInApp(true); setAppView("dashboard"); };
  const handleLogout = () => { setInApp(false); setView("landing"); };
